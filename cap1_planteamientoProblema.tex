...
\item  
¿En cuánto se ree4||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||°°°|duce el tiempo de consolidación de apuntes manuscritos y cuál es el incremento en la tasa de preservación de información técnica mediante el uso de la aplicación con un módulo de transcripción automatizada (TrOCR) frente a los métodos de transcripción tradicional?
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{image/unamba.png}

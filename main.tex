...
\setlength{\bibhang}{0pt} % Sin sangría francesa en la bibliografía (recto)
\setlength{\bibitemsep}{0pt} % Sin espacio vertical de biblatex
\renewbibmacro*{finentry}{\finentry\par ~} % Línea en blanco numerada entre referencias
...
% --- Citas en negrita (formato APA) ---
\AtEveryCite{\bfseries}
...
\end{center}
\input{cap2_objetivos_hipotesis}
...
% \end{center}
% \input{cap5_resultados_discusiones}
